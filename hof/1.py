# Write a select function that mimics the built-in filter function. Your select 
# function should take two arguments: a callback function and an iterable 
# object. It should return a list of all the elements of the iterable for 
# which the callback function returns a truthy value. It should not include 
